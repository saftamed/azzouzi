                ...
                <div class="relative mb-4 h-10">
                    ...
                    >
                        ...
                        <div class="flex flex-row mb-1 sm:mb-0 ml-2">
                            <button
                                @click="showMaEdit({machine_id:machine.id})"
                                class="
                                    inline-flex
                                    items-center
                                    justify-center
                            ...
                            <form class="max-w-lg mx-auto">
                                <div class="mb-6">
                                    ...
                                    >
                                        ...
                                        <span class="text-gray-700">Select Year</span>
                                        <select v-model="p.y" class="form-select block w-full mt-1">
                                            <option value='55' selected>--Select Year--</option>
                                            <option v-for="y in dd" :key="y" :value="y">{{y}}</option>
                                        </select>
                                        </label>
                                        <label class="block text-left" style="max-width: 400px">
                                        <span class="text-gray-700">Select Month</span>
                                        <select v-model="p.m" class="form-select block w-full mt-1">
                                             <option value='55' selected>--Select Month--</option>
                                            ...
                                            <option value=''>All Month of the Year</option>
                                        </select>
                                        </label>
                                </div>
                            </form>
...
export default defineComponent({
    ...
    methods: {
        printM() {
            axios.post("/machine/print",{...this.p,id:this.machine.id}).then((response) => {
